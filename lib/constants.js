...
// Keyword-matched real stock photography (via loremflickr) so each asset
// card's image is actually relevant to its title/category — a random
// picsum seed has no relationship to what the card is describing. Still a
// placeholder pending real listing photography; see Future Roadmap.
function photo(keywords, w = 1200, h = 900) {
...
export const PROPERTIES = [
  {
    ...
    sqft: 9800,
    status: "For Sale",
    image: "https://images.pexels.com/photos/20412791/pexels-photo-20412791.jpeg",
  },
  {
    id: "prop-2",
    ...
    sqft: 7400,
    status: "For Sale",
    image: "https://images.pexels.com/photos/21297784/pexels-photo-21297784.jpeg",
  },
  {
    id: "prop-3",
    ...
    sqft: 6100,
    status: "For Sale",
    image:"https://images.pexels.com/photos/35996694/pexels-photo-35996694.jpeg",
  },
  {
    id: "prop-4",
    title: "Isla Serena",
    ...
    status: "For Sale",
    image: "https://images.pexels.com/photos/34823937/pexels-photo-34823937.jpeg",
  },
  {
    id: "prop-5",
  ...
  },
  {
    ...
    sqft: 11200,
    status: "For Rent",
    image: photo("mountainhouse,aspen,luxury"),
  },
];
...
export const JETS = [
  {
    ...
    status: "For Sale",
    image: photo("privatejet,gulfstream,aircraft"),
  },
  {
    id: "jet-2",
    ...
    status: "For Sale",
    image: photo("privatejet,runway,aviation"),
  },
  {
    id: "jet-3",
    ...
    status: "Charter",
    image: photo("businessjet,cessna,airport"),
  },
  {
    id: "jet-4",
    ...
    status: "For Sale",
    image: photo("privatejet,aviation,tarmac"),
  },
];
...
export const CARS = [
  {
    ...
    status: "For Sale",
    image: photo("ferrari,supercar,red"),
  },
  {
    id: "car-2",
    ...
    status: "For Sale",
    image: photo("lamborghini,supercar"),
  },
  {
    id: "car-3",
  ...
  },
  {
    ...
    status: "For Sale",
    image: photo("rollsroyce,luxurycar"),
  },
  {
    id: "car-5",
...
export const YACHTS = [
  {
    ...
    status: "For Sale",
    image: "https://images.pexels.com/photos/42091/pexels-photo-42091.jpeg",
  },
  {
    id: "yacht-2",
    title: "S/Y Meridian",
    ...
    status: "For Sale",
    image: photo("yacht,explorer,sea"),
  },
  {
    id: "yacht-3",
    ...
    status: "Charter",
    image: photo("yacht,charter,mediterranean"),
  },
  {
    id: "yacht-4",
    ...
    status: "For Sale",
    image: photo("superyacht,luxury,marina"),
  },
];
...
export const WATCHES = [
  {
    ...
    status: "For Sale",
    image: "https://images.pexels.com/photos/9561300/pexels-photo-9561300.jpeg",
  },
  {
    id: "watch-2",
    ...
    status: "For Sale",
    image: photo("luxurywatch,watch,steel"),
  },
  {
    id: "watch-3",
    ...
    status: "For Sale",
    image: photo("luxurywatch,chronograph"),
  },
  {
    id: "watch-4",
  ...
  },
  {
    ...
    status: "For Sale",
    image: photo("vintagewatch,watchcollection"),
  },
];
...
export const WHY_JOIN = [
  ...
  },
  {
    ...
    description:
      "Luxora is positioned exclusively for high-value assets, keeping your listings among a genuinely comparable audience.",
  },
  {
    icon: "ShieldCheck",
...
// The "Other Marketplaces vs. Our Marketplace" comparison block on the
// homepage Why Join section — pairs against WHY_JOIN, which supplies the
// checkmark column.
export const WHY_JOIN_OTHERS = [
  "Unverified sellers and listings",
  "Generic, mass-market audience",
  "Hidden fees and long contracts",
  "Outdated or low-quality photography",
...
export const TESTIMONIALS = [
  {
    ...
    kind: "quote",
    quote:
      "Luxora changed how we sell nine-figure listings. The audience is genuinely qualified — no tire-kickers.",
  ...
  },
  {
    id: "t4",
    kind: "video",
    quote: "Watch how a Luxora partnership tripled our qualified inbound leads in one quarter.",
    name: "Marcus Alden",
...
export const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        q: "How does Luxora verify agents and partners?",
      ...
      },
      {
        ...
        a: "It signals that a partner's identity, business standing, and listing history have been reviewed directly by the Luxora team — not just self-reported.",
      },
    ],
  },
  {
...
export const BLOG_POSTS = [
  ...
  {
    id: "blog-6",
    title: "What 'Verified Marketplace' Actually Means at Luxora",
    category: "News",
    date: "2026-03-05",
    author: "Marcus Alden",
